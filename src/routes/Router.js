...
const NewsForm = Loadable(lazy(() => import('../views/form-validation/NewsForm')));
...
/***** Table Pages ****/
const User = Loadable(lazy(() => import('../views/tables/User')));
const Products = Loadable(lazy(() => import('../views/tables/Products')));
const News = Loadable(lazy(() => import('../views/tables/News')));
const Match = Loadable(lazy(() => import('../views/tables/Match')));
const Booking = Loadable(lazy(() => import('../views/tables/Booking')));
...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      { path: '/tables/User', name: 'User', exact: true, element: <User /> },
      { path: '/tables/Products', name: 'Productss', exact: true, element: <Products /> },
      { path: '/tables/News', name: 'Newss', exact: true, element: <News /> },
      { path: '/tables/Match', name: 'Match', exact: true, element: <Match /> },
      { path: '/tables/Booking', name: 'Booking', exact: true, element: <Booking /> },
